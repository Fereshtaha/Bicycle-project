...
public interface OrderDetailsRepository extends JpaRepository<OrderDetails, Integer> {
    @Query(value = "SELECT * FROM public.order_details where order_number = :orderNumber")
    Optional<OrderDetails> findByOrderNumber(@Param("order_number") String orderNumber);
